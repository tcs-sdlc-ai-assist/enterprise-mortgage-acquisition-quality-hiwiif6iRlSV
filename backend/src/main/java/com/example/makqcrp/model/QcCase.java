...
@Entity
@Table(name = "qc_cases", uniqueConstraints = @UniqueConstraint(columnNames = "case_number"))
public class QcCase {
    ...
    public QcCase(Long id, String caseNumber, String title, String description, String status, String priority,
    ...
    public boolean equals(Object o) {
        ...
        QcCase qcCase = (QcCase) o;
        return Objects.equals(caseNumber, qcCase.caseNumber);
    }
